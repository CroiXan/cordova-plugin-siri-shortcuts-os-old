...
exports.donate = function (options) {
    return new Promise(function(resolve, reject) {
        exec(resolve, reject, 'SiriShortcuts', 'donate', [options.persistentIdentifier, options.title, options.suggestedInvocationPhrase, options.userInfo, options.isEligibleForSearch, options.isEligibleForPrediction]);
    });
};
 ...
 * @return void
 */
 exports.check = function (persistentIdentifiers, success, error) {
    if (typeof persistentIdentifiers === 'string') {
        persistentIdentifiers = [persistentIdentifiers];
    }

    exec(success, error, 'SiriShortcuts', 'check', [persistentIdentifiers]);
};